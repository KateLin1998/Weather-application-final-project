    ...
    days.forEach(function(day) {
        ...
        `
                ...
                <div class="col-2">
                    ...
                    ${day}</div>
                <img src="https://ssl.gstatic.com/onebox/weather/48/sunny.png" alt="" width="50" height="50" />
                <div class="weather-forecast-temperature">
                <span class="weather-forecast-temperaute-max">18</span> 
                <span class="weather-forecast-temperaute-min">12</span>
            </div>
            </div>
        `;
    })
